...
export const catalogoJuegos = [
    ...
    {nombre: "The Witcher 3: Wild Hunt", genero: "Rol", plataforma: "PC", fechaLanzamiento: new Date("2015-05-19")},
    {nombre: "Resident Evil 7: Biohazard", genero: "Terror", plataforma: "PC", fechaLanzamiento: new Date("2017-01-24")},
    {nombre: "Mario Kart 8 Deluxe", genero: "Carreras", plataforma: "Nintendo Switch", fechaLanzamiento: new Date("2017-04-28")},
    {nombre: "Among Us", genero: "Otros", plataforma: "PC", fechaLanzamiento: new Date("2018-06-15")}
]